//
//  MachineCoreSummaryCollectionViewController+CollectionView.swift
//  AmadaMachines
//
...
extension MachineCoreSummaryCollectionViewController: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    @objc func handleAddToCart() {
        if let delegate = delegate {
            delegate.machineCoreSummaryCollectionViewController(self, addToCart: machine, machineOptions: machineOptions)
        }
    }
